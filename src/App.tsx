...
import { createUserProfile, updateUserPresence } from "./services/socialService";
      ...
      if (currentUser) {
        ...
        try {
          ...
          if (
            ...
            currentUser.email === "islammdnahidul407@gmail.com"
          ) {
            setIsAdmin(true);
          ...
          console.error("Firestore operation failed during login:", error);
        }
      } else {
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/admin/*"
          element={isAdmin ? <AdminDashboard user={user} isFirebaseAdmin={isFirebaseAdmin} /> : <Navigate to="/admin/login" />}
        />
        <Route
          path="/*"
          element={
