    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <main className="ml-64 p-8 min-h-screen">
        ...
        <Routes>
          ...
          <Route path="dashboard" element={<Overview adminId={user?.uid || "admin"} />} />
          <Route path="users" element={<UsersPage adminId={user?.uid || "admin"} />} />
          <Route path="posts" element={<PostsPage adminId={user?.uid || "admin"} />} />
          <Route path="reports" element={<ReportsPage adminId={user?.uid || "admin"} />} />
          <Route path="analytics" element={<AnalyticsPage />} />
          <Route path="settings" element={<SettingsPage adminId={user?.uid || "admin"} />} />
        </Routes>
      </main>
    </div>
  );
