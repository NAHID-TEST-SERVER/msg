...
const AdminLogin = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const isAdmin = user.email === "islammdnahidul407@gmail.com";
      ...
      if (isAdmin) {
        ...
        await auth.signOut();
        setError("You are not an administrator.\nDo not attempt to access the admin dashboard.\nRepeated attempts may result in your account being suspended.");
        setShake(true);
    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 font-sans selection:bg-emerald-500/30">
      ...
      >
        ...
        <motion.div
          ...
          className="bg-zinc-900/40 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 shadow-2xl shadow-black/50"
        >
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0a0a0a] px-2 text-zinc-500 tracking-widest uppercase">OR</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold py-4 rounded-2xl transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
